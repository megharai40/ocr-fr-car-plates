...
if img is not None:
  ...
  plate_number1 = license_plate_model.detectMultiScale(img_cv,1.04999,20)
  ...
  plate_number2 = license_plate_model.detectMultiScale(plate_imgcv,1.0099,20) #Extracting Plate 2nd time
